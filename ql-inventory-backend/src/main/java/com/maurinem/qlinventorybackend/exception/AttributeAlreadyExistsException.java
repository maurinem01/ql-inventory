package com.maurinem.qlinventorybackend.exception;
...
public class AttributeAlreadyExistsException extends RuntimeException {
	...
	public AttributeAlreadyExistsException(String parentClassName, Long parentClassId, String childClassName,
			Long childClassId) {
		super(String.format("%s ID# %s already has an assigned %s ID# %s.", parentClassName, parentClassId, childClassName,
				childClassId));
