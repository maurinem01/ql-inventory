...
/**
 * This class represents a Set of photography equipment. Each set is identified
 * by a number (not the same as the {@link PhotographySet#id id} used by the
 * database).
 * 
 * @author Maurine
 *
...
public class PhotographySet {
	...
	/**
	 * This number is used by the database as a unique identifier. It is not the set
	 * number.
	 */
	@Id
