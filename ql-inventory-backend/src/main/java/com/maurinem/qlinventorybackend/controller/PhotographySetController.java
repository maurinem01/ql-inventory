...
public class PhotographySetController {
	...
	public ResponseEntity<PhotographySet> savePhotographySet(@RequestBody PhotographySet photographySet) {
		...
		return new ResponseEntity<PhotographySet>(photographySetService.savePhotographySet(photographySet),
				HttpStatus.CREATED);
	}
	...
	@PutMapping("{id}")
	public ResponseEntity<PhotographySet> updatePhotographySet(@PathVariable("id") long id,
			@RequestBody PhotographySet photographySet) {
		return new ResponseEntity<PhotographySet>(photographySetService.updatePhotographySet(photographySet, id),
				HttpStatus.OK);
	}
