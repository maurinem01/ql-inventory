...
import com.maurinem.qlinventorybackend.exception.AttributeAlreadyExistsException;
...
import com.maurinem.qlinventorybackend.repository.ItemRepository;
...
public class ItemServiceImpl implements ItemService {
	...
	public Item addItemToPhotographySet(long itemId, long photoSetId) {
		...
		if (existingItem.getPhotographySet() == null) {
			...
			throw new AttributeAlreadyExistsException("Item", existingItem.getId(), "PhotographySet",
					existingPhotographySet.getId());
		}
