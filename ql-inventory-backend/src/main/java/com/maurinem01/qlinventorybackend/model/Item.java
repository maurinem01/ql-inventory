...
/**
 * This class represents an equipment/item.  Each {@code Item} is categorized to a {@link Part} and can be assigned to a {@link PhotographySet}.
 * @author Maurine
 *
 */
@Entity
...
public class Item {
	...
	/**
	 * Represents a serial number or license plate.  This property is only relevant for serialized items and is {@code null} for non-serialized items.
	 */
	@Column(name = "identifier", unique = true)
	private String identifier;
	
	/**
	 * Sometimes, the vans have "names".  This property represents any quirky aliases given to equipment.
	 */
	@Column(name = "alias")
