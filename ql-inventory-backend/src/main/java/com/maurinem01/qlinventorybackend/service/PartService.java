...
/**
 * A {@link com.maurinem01.qlinventorybackend.model.Part Part} cannot be deleted.  If obsolete, set {@link com.maurinem01.qlinventorybackend.model.Part#setDepracated(boolean) Part.setDepracated()} to {@code true}.
 * @author Maurine
 *
 */
